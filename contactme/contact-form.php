...
$fields[] = array('name' => 'service',		'display_name' => 'Service',          'type' => 'select',           'required' => true);
// $fields[] = array('name' => 'message',		'display_name' => 'Message',        'type' => 'text',        'required' => true);
// $fields[] = array('name' => 'subject',		'display_name' => 'Subject',        'type' => 'select',        'required' => false);
// $fields[] = array('name' => 'message',		'display_name' => 'Message',        'type' => 'textarea',      'required' => false);
// $fields[] = array('name' => 'files',		'display_name' => 'Upload file',    'type' => 'file',          'required' => false);
// $fields[] = array('name' => 'option',		'display_name' => 'Option',         'type' => 'radio',         'required' => false);
